...
if wheels:
    ...
    env_content = f"""# Serverless Base Environment for NEMWEB Lab
# Auto-generated by setup notebook
#
# To use as workspace default:
# 1. Settings > Compute > Base environments > Manage
# 2. Create new environment, select this file
